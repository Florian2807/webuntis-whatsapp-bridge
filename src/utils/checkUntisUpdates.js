module.exports = async ({classID}) => {
    ...
    Object.keys(timetable).forEach((day) => {
        ...
        lessonsPerDay[day] = timetable[day].map(i => wb.Utils.translateCellstate(i.cellState, i.teacher.filter(t => t)).cellstate).filter(i => ["STANDARD", "SUBSTITUTION"].includes(i)).length
    })
